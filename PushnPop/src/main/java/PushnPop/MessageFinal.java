...
/**
* creates the message id that the database uses connecting the identification 
* number with the category number
* 
...
* 
* @return myID A String value that represents the final ID of the message that 
