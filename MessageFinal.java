...
public class MessageFinal {
	...
	public void selectmessage(String category) {
		...
		String myselect = " SELECT * FROM Message WHERE category LIKE ?;";
		try {
			conn = SQLiteConnectionB.ConnectDb();
...
public static String testMethod(ArrayList<String> a, String top) {
		...
		System.out.println("i isssssssssssssssssssssssssssssssssss:" + i);
		...
		while (i < intFirsts.length && intFirsts[i] == Integer.parseInt(top) ) {
			...
			System.out.println("max is:" +maxp);
			i++;			
		}
		...
		for (i = (a.size() - 1); i > 0; i--) {
			...
			case  "1":
				...
				if (check1 == false) {
					...
					lastRows[0] = Integer.parseInt(testMethod(a,lalala));
			...
			case "2":
				...
				if (check2 == false) {
					...
					lastRows[1] = Integer.parseInt(testMethod(a,lalala));
			...
			case "3":
				...
				if (check3 == false) {
					...
					lastRows[2] = Integer.parseInt(testMethod(a,lalala));
			...
			case "4":
				...
				if (check4 == false) {
					...
					lastRows[3] = Integer.parseInt(testMethod(a,lalala));					
					check4 = true;
					c++;
				}
				break;
			...
			case "5":
				...
				if (check5 == false) {
					...
					lastRows[4] = Integer.parseInt(testMethod(a,lalala));
			...
			case "6":
				...
				if (check6 == false) {					
					lastRows[5] = Integer.parseInt(testMethod(a,lalala));					
					check6 = true;
					c++;
				}
				break;
